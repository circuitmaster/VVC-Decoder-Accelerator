set moduleName IDCT8B16_Pipeline_VITIS_LOOP_47_1
set isTopModule 0
...
set cdfgNum 9
set C_modelName {IDCT8B16_Pipeline_VITIS_LOOP_47_1}
...
set C_modelArgList {
	...
	{ oMin int 32 regular  }
	{ oMax int 32 regular  }
	{ empty_42 int 28 regular  }
	{ cutoff int 32 regular  }
	{ empty_43 int 29 regular  }
	{ empty_44 int 30 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "dst_0", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "empty_42", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "cutoff", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "empty_43", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
 	{ "Name" : "empty_44", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ dst_15 sc_out sc_lv 32 signal 1 } 
	{ dst_15_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ dst_14 sc_out sc_lv 32 signal 2 } 
	{ dst_14_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ dst_13 sc_out sc_lv 32 signal 3 } 
	{ dst_13_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ dst_12 sc_out sc_lv 32 signal 4 } 
	{ dst_12_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ dst_11 sc_out sc_lv 32 signal 5 } 
	{ dst_11_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ dst_10 sc_out sc_lv 32 signal 6 } 
	{ dst_10_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ dst_9 sc_out sc_lv 32 signal 7 } 
	{ dst_9_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ dst_8 sc_out sc_lv 32 signal 8 } 
	{ dst_8_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ dst_7 sc_out sc_lv 32 signal 9 } 
	{ dst_7_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ dst_6 sc_out sc_lv 32 signal 10 } 
	{ dst_6_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ dst_5 sc_out sc_lv 32 signal 11 } 
	{ dst_5_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ dst_4 sc_out sc_lv 32 signal 12 } 
	{ dst_4_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ dst_3 sc_out sc_lv 32 signal 13 } 
	{ dst_3_ap_vld sc_out sc_logic 1 outvld 13 } 
	{ dst_2 sc_out sc_lv 32 signal 14 } 
	{ dst_2_ap_vld sc_out sc_logic 1 outvld 14 } 
	{ dst_1 sc_out sc_lv 32 signal 15 } 
	{ dst_1_ap_vld sc_out sc_logic 1 outvld 15 } 
	{ src_0_val sc_in sc_lv 32 signal 16 } 
	{ src_1_val sc_in sc_lv 32 signal 17 } 
	{ src_2_val sc_in sc_lv 32 signal 18 } 
	{ src_3_val sc_in sc_lv 32 signal 19 } 
	{ src_4_val sc_in sc_lv 32 signal 20 } 
	{ src_5_val sc_in sc_lv 32 signal 21 } 
	{ src_6_val sc_in sc_lv 32 signal 22 } 
	{ src_7_val sc_in sc_lv 32 signal 23 } 
	{ src_8_val sc_in sc_lv 32 signal 24 } 
	{ src_9_val sc_in sc_lv 32 signal 25 } 
	{ src_10_val sc_in sc_lv 32 signal 26 } 
	{ src_11_val sc_in sc_lv 32 signal 27 } 
	{ src_12_val sc_in sc_lv 32 signal 28 } 
	{ src_13_val sc_in sc_lv 32 signal 29 } 
	{ src_14_val sc_in sc_lv 32 signal 30 } 
	{ src_15_val sc_in sc_lv 32 signal 31 } 
	{ conv3_i12_i_i sc_in sc_lv 32 signal 32 } 
	{ sh_prom_i9_i_i sc_in sc_lv 32 signal 33 } 
	{ sh_prom_i_i_i sc_in sc_lv 32 signal 34 } 
	{ empty_41 sc_in sc_lv 1 signal 35 } 
	{ oMin sc_in sc_lv 32 signal 36 } 
	{ oMax sc_in sc_lv 32 signal 37 } 
	{ empty_42 sc_in sc_lv 28 signal 38 } 
	{ cutoff sc_in sc_lv 32 signal 39 } 
	{ empty_43 sc_in sc_lv 29 signal 40 } 
	{ empty_44 sc_in sc_lv 30 signal 41 } 
	{ empty sc_in sc_lv 31 signal 42 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "empty_42", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "empty_42", "role": "default" }} , 
 	{ "name": "cutoff", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "cutoff", "role": "default" }} , 
 	{ "name": "empty_43", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "empty_43", "role": "default" }} , 
 	{ "name": "empty_44", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "empty_44", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_0_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_1_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_2_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_3_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_4_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_5_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_6_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_7_U", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_8_U", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_9_U", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_10_U", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_11_U", "Parent" : "0"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_12_U", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_13_U", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_14_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_ZL8idct8_16_15_U", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_7ns_32s_32_2_1_U65", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U66", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U67", "Parent" : "0"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U68", "Parent" : "0"},
	{"ID" : "21", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U69", "Parent" : "0"},
	{"ID" : "22", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U70", "Parent" : "0"},
	{"ID" : "23", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U71", "Parent" : "0"},
	{"ID" : "24", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U72", "Parent" : "0"},
	{"ID" : "25", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U73", "Parent" : "0"},
	{"ID" : "26", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U74", "Parent" : "0"},
	{"ID" : "27", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U75", "Parent" : "0"},
	{"ID" : "28", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U76", "Parent" : "0"},
	{"ID" : "29", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U77", "Parent" : "0"},
	{"ID" : "30", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U78", "Parent" : "0"},
	{"ID" : "31", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U79", "Parent" : "0"},
	{"ID" : "32", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_32s_32_2_1_U80", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	empty_42 { ap_none {  { empty_42 in_data 0 28 } } }
	cutoff { ap_none {  { cutoff in_data 0 32 } } }
	empty_43 { ap_none {  { empty_43 in_data 0 29 } } }
	empty_44 { ap_none {  { empty_44 in_data 0 30 } } }
