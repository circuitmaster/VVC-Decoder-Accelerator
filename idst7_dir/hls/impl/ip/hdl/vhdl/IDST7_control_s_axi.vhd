...
end entity IDST7_control_s_axi;
...
architecture behave of IDST7_control_s_axi is
    ...
    constant ADDR_SIN_DATA_0        : INTEGER := 16#30#;
    constant ADDR_SIN_CTRL          : INTEGER := 16#34#;
    constant ADDR_SIZE_DATA_0       : INTEGER := 16#38#;
    constant ADDR_SIZE_CTRL         : INTEGER := 16#3c#;
    constant ADDR_SHIFT_DATA_0      : INTEGER := 16#40#;
    constant ADDR_SHIFT_CTRL        : INTEGER := 16#44#;
    constant ADDR_OMIN_DATA_0       : INTEGER := 16#48#;
    constant ADDR_OMIN_CTRL         : INTEGER := 16#4c#;
    constant ADDR_OMAX_DATA_0       : INTEGER := 16#50#;
    constant ADDR_OMAX_CTRL         : INTEGER := 16#54#;
    ...
    signal int_sIn             : UNSIGNED(31 downto 0) := (others => '0');
    signal int_size            : UNSIGNED(31 downto 0) := (others => '0');
    signal int_shift           : UNSIGNED(31 downto 0) := (others => '0');
    signal int_oMin            : UNSIGNED(31 downto 0) := (others => '0');
    signal int_oMax            : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_SIN_DATA_0 =>
                        rdata_data <= RESIZE(int_sIn(31 downto 0), 32);
                    ...
                    when ADDR_OMIN_DATA_0 =>
                        rdata_data <= RESIZE(int_oMin(31 downto 0), 32);
                    when ADDR_OMAX_DATA_0 =>
                        rdata_data <= RESIZE(int_oMax(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    sIn                  <= STD_LOGIC_VECTOR(int_sIn);
    size                 <= STD_LOGIC_VECTOR(int_size);
    shift                <= STD_LOGIC_VECTOR(int_shift);
    oMin                 <= STD_LOGIC_VECTOR(int_oMin);
    oMax                 <= STD_LOGIC_VECTOR(int_oMax);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (w_hs = '1' and waddr = ADDR_BLOCK_SIZE_DATA_0) then
                    int_block_size(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_block_size(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_sIn(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SIN_DATA_0) then
                    int_sIn(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_sIn(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_oMin(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OMIN_DATA_0) then
                    int_oMin(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_oMin(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_oMax(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OMAX_DATA_0) then
                    int_oMax(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_oMax(31 downto 0));
                end if;
            end if;
        end if;
    end process;
