...
define void @apatb_IDST7_ir(%"struct.ap_int<1024>"* noalias nocapture nonnull readonly "maxi" %in, %"struct.ap_int<1024>"* noalias nocapture nonnull "maxi" %out, %"struct.ap_int<32>"* nocapture readonly %block_size, %"struct.ap_int<32>"* nocapture readonly %sIn, %"struct.ap_int<32>"* nocapture readonly %size, %"struct.ap_int<32>"* nocapture readonly %shift, %"struct.ap_int<32>"* nocapture readonly %oMin, %"struct.ap_int<32>"* nocapture readonly %oMax) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_IDST7_hw(i1024* %in_copy, i1024* %out_copy, %"struct.ap_int<32>"* %block_size, %"struct.ap_int<32>"* %sIn, %"struct.ap_int<32>"* %size, %"struct.ap_int<32>"* %shift, %"struct.ap_int<32>"* %oMin, %"struct.ap_int<32>"* %oMax)
...
declare void @apatb_IDST7_hw(i1024*, i1024*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)
...
declare void @IDST7_hw_stub(%"struct.ap_int<1024>"* noalias nocapture nonnull readonly, %"struct.ap_int<1024>"* noalias nocapture nonnull, %"struct.ap_int<32>"* nocapture readonly, %"struct.ap_int<32>"* nocapture readonly, %"struct.ap_int<32>"* nocapture readonly, %"struct.ap_int<32>"* nocapture readonly, %"struct.ap_int<32>"* nocapture readonly, %"struct.ap_int<32>"* nocapture readonly)

define void @IDST7_hw_stub_wrapper(i1024*, i1024*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*) #4 {
entry:
  ...
  call void @IDST7_hw_stub(%"struct.ap_int<1024>"* %9, %"struct.ap_int<1024>"* %11, %"struct.ap_int<32>"* %2, %"struct.ap_int<32>"* %3, %"struct.ap_int<32>"* %4, %"struct.ap_int<32>"* %5, %"struct.ap_int<32>"* %6, %"struct.ap_int<32>"* %7)
