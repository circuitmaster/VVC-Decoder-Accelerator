...
void IDST7B8(ap_int<32> src[8], ap_int<32> dst[8], ap_int<32> shift,  ap_int<32> skipLine2, const ap_int<32> oMin, const ap_int<32> oMax) {
    INV_MATMUL_8(src, dst, shift, skipLine2, oMin, oMax, idst7_8);
}

void IDST7B16(ap_int<32> src[16], ap_int<32> dst[16], ap_int<32> shift , ap_int<32> skipLine2, const ap_int<32> oMin, const ap_int<32> oMax){
...
void IDST7B32(ap_int<32> src[32], ap_int<32> dst[32], ap_int<32> shift, ap_int<32> skipLine2, const ap_int<32> oMin, const ap_int<32> oMax){
...
extern "C" void IDST7(ap_int<1024>* in, ap_int<1024>* out, ap_int<32> block_size, ap_int<32> sIn, ap_int<32>  size, ap_int<32>  shift, ap_int<32>  oMin, ap_int<32>  oMax) {
    ...
    for(int i=0; i<size; i++){
       ...
       if(block_size == 32){
            ...
            IDST7B32(in_data, out_data, shift, sIn, oMin, oMax);
            ...
            IDST7B16(in_data, out_data, shift, sIn, oMin, oMax);
            ...
            IDST7B8(in_data, out_data, shift, sIn, oMin, oMax);
            ...
            IDST7B4(in_data, out_data, shift, oMin, oMax);
