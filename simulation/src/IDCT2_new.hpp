...
void IDCT2B64(ap_int<32> in1[32], ap_int<32> in2[32], ap_int<32> out1[32], ap_int<32> out2[32]){
    ...
    ap_int<16> in1_a = in1[1] << 6;
    ap_int<16> in1_b = in1[1] << 5;
    ap_int<16> in1_c = in1[1] << 4;
    ap_int<16> in1_d = in1[1] << 3;
    ap_int<16> in1_e = in1[1] << 2;
    ap_int<16> in1_f = in1[1] << 1;
    ap_int<8> in1_g = in1[1];

    ap_int<16> in3_a = in1[3] << 6;
    ap_int<16> in3_b = in1[3] << 5;
    ap_int<16> in3_c = in1[3] << 4;
    ap_int<16> in3_d = in1[3] << 3;
    ap_int<16> in3_e = in1[3] << 2;
    ap_int<16> in3_f = in1[3] << 1;
    ap_int<8> in3_g = in1[3];

    ap_int<16> in5_a = in1[5] << 6;
    ap_int<16> in5_b = in1[5] << 5;
    ap_int<16> in5_c = in1[5] << 4;
    ap_int<16> in5_d = in1[5] << 3;
    ap_int<16> in5_e = in1[5] << 2;
    ap_int<16> in5_f = in1[5] << 1;
    ap_int<8> in5_g = in1[5];

    ap_int<16> in7_a = in1[7] << 6;
    ap_int<16> in7_b = in1[7] << 5;
    ap_int<16> in7_c = in1[7] << 4;
    ap_int<16> in7_d = in1[7] << 3;
    ap_int<16> in7_e = in1[7] << 2;
    ap_int<16> in7_f = in1[7] << 1;
    ap_int<8> in7_g = in1[7];

    ap_int<16> in9_a = in1[9] << 6;
    ap_int<16> in9_b = in1[9] << 5;
    ap_int<16> in9_c = in1[9] << 4;
    ap_int<16> in9_d = in1[9] << 3;
    ap_int<16> in9_e = in1[9] << 2;
    ap_int<16> in9_f = in1[9] << 1;
    ap_int<8> in9_g = in1[9];

    ap_int<16> in11_a = in1[11] << 6;
    ap_int<16> in11_b = in1[11] << 5;
    ap_int<16> in11_c = in1[11] << 4;
    ap_int<16> in11_d = in1[11] << 3;
    ap_int<16> in11_e = in1[11] << 2;
    ap_int<16> in11_f = in1[11] << 1;
    ap_int<8> in11_g = in1[11];

    ap_int<16> in13_a = in1[13] << 6;
    ap_int<16> in13_b = in1[13] << 5;
    ap_int<16> in13_c = in1[13] << 4;
    ap_int<16> in13_d = in1[13] << 3;
    ap_int<16> in13_e = in1[13] << 2;
    ap_int<16> in13_f = in1[13] << 1;
    ap_int<8> in13_g = in1[13];

    ap_int<16> in15_a = in1[15] << 6;
    ap_int<16> in15_b = in1[15] << 5;
    ap_int<16> in15_c = in1[15] << 4;
    ap_int<16> in15_d = in1[15] << 3;
    ap_int<16> in15_e = in1[15] << 2;
    ap_int<16> in15_f = in1[15] << 1;
    ap_int<8> in15_g = in1[15];

    ap_int<16> in17_a = in1[17] << 6;
    ap_int<16> in17_b = in1[17] << 5;
    ap_int<16> in17_c = in1[17] << 4;
    ap_int<16> in17_d = in1[17] << 3;
    ap_int<16> in17_e = in1[17] << 2;
    ap_int<16> in17_f = in1[17] << 1;
    ap_int<8> in17_g = in1[17];

    ap_int<16> in19_a = in1[19] << 6;
    ap_int<16> in19_b = in1[19] << 5;
    ap_int<16> in19_c = in1[19] << 4;
    ap_int<16> in19_d = in1[19] << 3;
    ap_int<16> in19_e = in1[19] << 2;
    ap_int<16> in19_f = in1[19] << 1;
    ap_int<8> in19_g = in1[19];

    ap_int<16> in21_a = in1[21] << 6;
    ap_int<16> in21_b = in1[21] << 5;
    ap_int<16> in21_c = in1[21] << 4;
    ap_int<16> in21_d = in1[21] << 3;
    ap_int<16> in21_e = in1[21] << 2;
    ap_int<16> in21_f = in1[21] << 1;
    ap_int<8> in21_g = in1[21];

    ap_int<16> in23_a = in1[23] << 6;
    ap_int<16> in23_b = in1[23] << 5;
    ap_int<16> in23_c = in1[23] << 4;
    ap_int<16> in23_d = in1[23] << 3;
    ap_int<16> in23_e = in1[23] << 2;
    ap_int<16> in23_f = in1[23] << 1;
    ap_int<8> in23_g = in1[23];

    ap_int<16> in25_a = in1[25] << 6;
    ap_int<16> in25_b = in1[25] << 5;
    ap_int<16> in25_c = in1[25] << 4;
    ap_int<16> in25_d = in1[25] << 3;
    ap_int<16> in25_e = in1[25] << 2;
    ap_int<16> in25_f = in1[25] << 1;
    ap_int<8> in25_g = in1[25];

    ap_int<16> in27_a = in1[27] << 6;
    ap_int<16> in27_b = in1[27] << 5;
    ap_int<16> in27_c = in1[27] << 4;
    ap_int<16> in27_d = in1[27] << 3;
    ap_int<16> in27_e = in1[27] << 2;
    ap_int<16> in27_f = in1[27] << 1;
    ap_int<8> in27_g = in1[27];

    ap_int<16> in29_a = in1[29] << 6;
    ap_int<16> in29_b = in1[29] << 5;
    ap_int<16> in29_c = in1[29] << 4;
    ap_int<16> in29_d = in1[29] << 3;
    ap_int<16> in29_e = in1[29] << 2;
    ap_int<16> in29_f = in1[29] << 1;
    ap_int<8> in29_g = in1[29];

    ap_int<16> in31_a = in1[31] << 6;
    ap_int<16> in31_b = in1[31] << 5;
    ap_int<16> in31_c = in1[31] << 4;
    ap_int<16> in31_d = in1[31] << 3;
    ap_int<16> in31_e = in1[31] << 2;
