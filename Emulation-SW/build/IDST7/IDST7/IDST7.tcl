...
open_project IDST7
set_top IDST7
# v++ -g, -D, -I, --advanced.prop kernel.IDST7.kernel_flags
add_files "/home/emre24/Desktop/vvc_proj_kernels/src/IDST7.cpp" -cflags " -I /home/emre24/Desktop/vvc_proj_kernels/src"
...
config_export -format xo -ipname IDST7
