; ModuleID = '/home/emre24/Desktop/vvc_proj_kernels/Emulation-SW/build/IDST7/IDST7/IDST7/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_IDST7_ir(%"struct.ap_int<512>"* noalias nocapture nonnull readonly %in, %"struct.ap_int<512>"* noalias nocapture nonnull %out, %"struct.ap_int<32>"* nocapture readonly %block_size, %"struct.ap_int<32>"* nocapture readonly %sIn, %"struct.ap_int<32>"* nocapture readonly %size, %"struct.ap_int<32>"* nocapture readonly %shift, %"struct.ap_int<32>"* nocapture readonly %oMin, %"struct.ap_int<32>"* nocapture readonly %oMax) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_IDST7_hw(%"struct.ap_int<512>"* %in_copy, %"struct.ap_int<512>"* %out_copy, %"struct.ap_int<32>"* %block_size, %"struct.ap_int<32>"* %sIn, %"struct.ap_int<32>"* %size, %"struct.ap_int<32>"* %shift, %"struct.ap_int<32>"* %oMin, %"struct.ap_int<32>"* %oMax)
...
declare void @apatb_IDST7_hw(%"struct.ap_int<512>"*, %"struct.ap_int<512>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)
...
define void @IDST7_hw_stub_wrapper(%"struct.ap_int<512>"*, %"struct.ap_int<512>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*) #4 {
entry:
  call void @copy_out(%"struct.ap_int<512>"* null, %"struct.ap_int<512>"* %0, %"struct.ap_int<512>"* null, %"struct.ap_int<512>"* %1)
  call void @IDST7_hw_stub(%"struct.ap_int<512>"* %0, %"struct.ap_int<512>"* %1, %"struct.ap_int<32>"* %2, %"struct.ap_int<32>"* %3, %"struct.ap_int<32>"* %4, %"struct.ap_int<32>"* %5, %"struct.ap_int<32>"* %6, %"struct.ap_int<32>"* %7)
  call void @copy_in(%"struct.ap_int<512>"* null, %"struct.ap_int<512>"* %0, %"struct.ap_int<512>"* null, %"struct.ap_int<512>"* %1)
  ret void
}

declare void @IDST7_hw_stub(%"struct.ap_int<512>"*, %"struct.ap_int<512>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)
